...
import runRenderAll, { findTemplates, resolveOutput } from '../../../ops/cmd/render-all.js'
...
function fakeEnv(extra = {}) {
  const vars = {
    ...
    CLOUDFLARED_CREDENTIALS_FILE_WEB: '/x.json',
    CLOUDFLARED_CREDENTIALS_FILE_MCP: '/y.json',
