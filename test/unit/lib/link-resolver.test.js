...
import { classifyLink, createLinkResolver, mapUrlToKey } from '../../../src/lib/link-resolver.js'

describe('mapUrlToKey', () => {
  test('developer.apple.com/documentation → framework key', () => {
    expect(mapUrlToKey('https://developer.apple.com/documentation/swiftui/view')).toBe('swiftui/view')
    expect(mapUrlToKey('https://developer.apple.com/documentation/SwiftUI/View')).toBe('swiftui/view')
    expect(mapUrlToKey('https://developer.apple.com/documentation/foundation/')).toBe('foundation')
  })

  test('developer.apple.com/design → design/ key', () => {
    expect(mapUrlToKey('https://developer.apple.com/design/human-interface-guidelines/foundations')).toBe('design/human-interface-guidelines/foundations')
  })
  ...
  test('developer.apple.com/library/archive → apple-archive key', () => {
    ...
    expect(mapUrlToKey('https://developer.apple.com/library/archive/documentation/Aperture/Conceptual/AppleApp_Aperture_3.4/Overview/Overview.html')).toBe(
      'apple-archive/documentation/Aperture/Conceptual/AppleApp_Aperture_3.4/Overview',
    )
    // `index.html` collapses too.
    expect(mapUrlToKey('https://developer.apple.com/library/archive/documentation/Foo/Bar/index.html')).toBe('apple-archive/documentation/Foo/Bar')
    // Distinct sibling stays terminal.
    expect(mapUrlToKey('https://developer.apple.com/library/archive/documentation/Foo/Bar/Sibling.html')).toBe(
      'apple-archive/documentation/Foo/Bar/Sibling.html',
    )
  })

  test('developer.apple.com/videos/play/wwdcYYYY/ID → wwdc/wwdcYYYY-ID', () => {
    expect(mapUrlToKey('https://developer.apple.com/videos/play/wwdc2024/10001/')).toBe('wwdc/wwdc2024-10001')
    expect(mapUrlToKey('https://developer.apple.com/videos/play/wwdc2025/281')).toBe('wwdc/wwdc2025-281')
  })

  test('docs.swift.org/{compiler,swiftpm,swift-book} → corpus slug', () => {
    expect(mapUrlToKey('https://docs.swift.org/compiler/documentation/diagnostics/diagnostic-groups')).toBe(
      'swift-compiler/documentation/diagnostics/diagnostic-groups',
    )
    expect(mapUrlToKey('https://docs.swift.org/swiftpm/documentation/packagemanagerdocs/usage')).toBe(
      'swift-package-manager/documentation/packagemanagerdocs/usage',
    )
    expect(mapUrlToKey('https://docs.swift.org/swift-book/documentation/the-swift-programming-language/thebasics/')).toBe(
      'swift-book/documentation/the-swift-programming-language/thebasics',
    )
  })

  test('swift.org redirect paths map to their archive home', () => {
    expect(mapUrlToKey('https://swift.org/documentation/concurrency')).toBe('swift-migration-guide/documentation/migrationguide')
    expect(mapUrlToKey('https://swift.org/documentation/package-manager/')).toBe('swift-package-manager/documentation/packagemanagerdocs')
    expect(mapUrlToKey('https://www.swift.org/documentation/tspl')).toBe('swift-book/The-Swift-Programming-Language')
  })

  test('swift.org/migration/* → swift-migration-guide/*', () => {
    expect(mapUrlToKey('https://swift.org/migration/documentation/swift-6-concurrency-migration-guide/dataracesafety')).toBe(
      'swift-migration-guide/documentation/swift-6-concurrency-migration-guide/dataracesafety',
    )
  })

  test('swift.org/swift-evolution/proposals → swift-evolution key', () => {
    expect(mapUrlToKey('https://swift.org/swift-evolution/proposals/0179-swift-run-command.html')).toBe('swift-evolution/0179-swift-run-command')
    expect(mapUrlToKey('https://github.com/apple/swift-evolution/blob/main/proposals/0253-callable.md')).toBe('swift-evolution/0253-callable')
  })
...
describe('createLinkResolver', () => {
  test('rewrites internalizable URLs to /docs/<key>/', () => {
    ...
    expect(resolve('https://docs.swift.org/compiler/documentation/diagnostics/')).toBe('/docs/swift-compiler/documentation/diagnostics/')
  })
  ...
  test('preserves URL fragments on internalized rewrites', () => {
    ...
    expect(resolve('/contributing/#reporting-bugs')).toBe('/docs/swift-org/contributing/#reporting-bugs')
  })
  ...
  test('swiftOrgPaths handles .html-suffixed curated entries', () => {
    ...
    expect(resolve('/documentation/server/guides/passkeys')).toBe('/docs/swift-org/documentation/server/guides/passkeys.html/')
  })
  ...
  test('rewrites swift.org redirect paths to their archive', () => {
    const knownKeys = new Set(['swift-package-manager/documentation/packagemanagerdocs', 'swift-migration-guide/documentation/migrationguide'])
    const resolve = createLinkResolver({ knownKeys, sourceUrl: 'https://swift.org/' })
    expect(resolve('/documentation/package-manager/')).toBe('/docs/swift-package-manager/documentation/packagemanagerdocs/')
    expect(resolve('/documentation/concurrency')).toBe('/docs/swift-migration-guide/documentation/migrationguide/')
  })

  test('rewrites apple.com developer URLs when key is in corpus', () => {
    const knownKeys = new Set(['swiftui/view'])
    const resolve = createLinkResolver({ knownKeys })
    expect(resolve('https://developer.apple.com/documentation/swiftui/view')).toBe('/docs/swiftui/view/')
  })

  test('leaves apple.com URL external when key is NOT in corpus', () => {
    const knownKeys = new Set()
    const resolve = createLinkResolver({ knownKeys })
    expect(resolve('https://developer.apple.com/documentation/missing/page')).toBe('https://developer.apple.com/documentation/missing/page')
  })
...
describe('classifyLink', () => {
  const knownKeys = new Set(['swiftui/view', 'swift-org/about', 'swift-compiler/documentation/diagnostics'])
