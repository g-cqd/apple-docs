...
const DOCS = [
  ...
  },
  {
    ...
    kind: 'struct',
    language: 'swift',
    abstractText: 'The root view of an app.',
    urlDepth: 2,
    isBeta: true,
  },
  {
  ...
  {
    key: 'swiftui/building-views',
    title: 'Building views with SwiftUI',
    framework: 'swiftui',
    sourceType: 'apple-docc',
    role: 'article',
    roleHeading: 'Article',
    kind: 'article',
    language: 'swift',
    abstractText: 'How to build views. A tutorial.',
    urlDepth: 2,
  },
  {
    key: 'uikit/uiview',
    ...
    kind: 'class',
    language: 'occ',
    abstractText: 'Manages content for a rectangular view area.',
    urlDepth: 2,
  },
  {
    key: 'hig/views',
    ...
    kind: 'article',
    language: 'both',
    abstractText: 'Design guidance for views.',
    urlDepth: 2,
  },
  {
    key: 'samples/view-sample',
    ...
    kind: 'sample',
    language: 'swift',
    abstractText: 'A sample showing a view.',
    urlDepth: 2,
  },
  {
    key: 'swiftui/release-notes/2024',
    ...
    kind: 'article',
    language: 'swift',
    abstractText: 'What changed in views this year.',
    urlDepth: 3,
    isReleaseNotes: true,
  },
  ...
  // both `...` ellipses (the term is not at index 0 and the text exceeds 220).
  {
    ...
    language: 'swift',
    abstractText:
      'Build adaptive, data-driven interfaces that fit every Apple platform and device size class, and learn how to compose a navigation hierarchy that moves between screens while preserving scroll position, deep links, and accessibility focus across the entire user journey from launch through to a detail screen.',
    urlDepth: 2,
  },
  ...
  // platform=ios filter must EXCLUDE it via the explicit-keys check).
  {
    ...
    kind: 'struct',
    language: 'swift',
    abstractText: 'A view available on iOS and macOS.',
    urlDepth: 2,
    platformsJson: { ios: '17.0', macos: '14.0', ipados: '17.0' },
    minIos: '17.0',
    minMacos: '14.0',
  },
  {
    key: 'swiftui/deskview',
    title: 'DeskView',
    framework: 'swiftui',
    sourceType: 'apple-docc',
    role: 'symbol',
    ...
    kind: 'struct',
    language: 'swift',
    abstractText: 'A desktop-only view for macOS apps.',
    urlDepth: 2,
    platformsJson: { macos: '15.0' },
    minMacos: '15.0',
  },
]
const QUERIES = [
  ...
  'uivew',
  'contentvieww',
  'how do you represent app interface parts',
  'deprecated programming interface guidance',
]
...
if (existsSync(AD_SERVER)) {
  ...
  seed.replaceDocumentSections(viewId, [
    {
      ...
      heading: 'Overview',
      contentText:
        'A view is the fundamental building block of a SwiftUI interface; you compose small views into a navigation hierarchy and layout that adapts to every device.',
      sortOrder: 0,
    },
    {
      sectionKind: 'discussion',
      heading: 'Storage',
      contentText: Buffer.from(
        Bun.zstdCompressSync(
          Buffer.from('This discussion section is stored zstd-compacted to exercise the decompress binding from the Swift section codec, end to end.'),
        ),
      ),
      sortOrder: 1,
    },
  ...
  seed.upsertDocument({
    ...
    kind: 'struct',
    language: 'swift',
    abstractText: 'A view in the su framework.',
    urlDepth: 2,
  })
  try {
