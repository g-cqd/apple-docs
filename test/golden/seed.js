...
export function seedDatabase(db) {
  ...
  // SwiftUI symbols
  const pages = [
    { rootId: swiftui.id, path: 'documentation/swiftui/view', url: 'u', title: 'View', role: 'symbol', roleHeading: 'Protocol', abstract: 'A type that represents part of your app user interface and provides modifiers', declaration: 'protocol View', platforms: ['iOS 13.0+', 'macOS 10.15+'] },
    { rootId: swiftui.id, path: 'documentation/swiftui/text', url: 'u', title: 'Text', role: 'symbol', roleHeading: 'Structure', abstract: 'A view that displays one or more lines of read-only text', declaration: 'struct Text', platforms: ['iOS 13.0+'] },
    { rootId: swiftui.id, path: 'documentation/swiftui/navigationstack', url: 'u', title: 'NavigationStack', role: 'symbol', roleHeading: 'Structure', abstract: 'A view that displays a root view and enables you to present additional views over the root view', declaration: 'struct NavigationStack<Data, Root> where Root : View', platforms: ['iOS 16.0+'] },
    { rootId: swiftui.id, path: 'documentation/swiftui/navigationsplitview', url: 'u', title: 'NavigationSplitView', role: 'symbol', roleHeading: 'Structure', abstract: 'A view that presents views in two or three columns', declaration: 'struct NavigationSplitView', platforms: ['iOS 16.0+'] },
    { rootId: swiftui.id, path: 'documentation/swiftui/navigationlink', url: 'u', title: 'NavigationLink', role: 'symbol', roleHeading: 'Structure', abstract: 'A view that controls a navigation presentation', declaration: 'struct NavigationLink<Label, Destination>', platforms: ['iOS 13.0+'] },
    { rootId: swiftui.id, path: 'documentation/swiftui/list', url: 'u', title: 'List', role: 'symbol', roleHeading: 'Structure', abstract: 'A container that presents rows of data arranged in a single column', declaration: 'struct List<SelectionValue, Content>', platforms: ['iOS 13.0+'] },
    ...
    // Foundation symbols
    { rootId: foundation.id, path: 'documentation/foundation/urlsession', url: 'u', title: 'URLSession', role: 'symbol', roleHeading: 'Class', abstract: 'An object that coordinates a group of related network data transfer tasks', declaration: 'class URLSession', platforms: ['iOS 7.0+'] },
    ...
    // UIKit symbols
    { rootId: uikit.id, path: 'documentation/uikit/uiview', url: 'u', title: 'UIView', role: 'symbol', roleHeading: 'Class', abstract: 'An object that manages the content for a rectangular area on the screen', declaration: 'class UIView : UIResponder' },
    { rootId: uikit.id, path: 'documentation/uikit/uiviewcontroller', url: 'u', title: 'UIViewController', role: 'symbol', roleHeading: 'Class', abstract: 'An object that manages a view hierarchy for your UIKit app', declaration: 'class UIViewController : UIResponder' },
    { rootId: uikit.id, path: 'documentation/uikit/uitableview', url: 'u', title: 'UITableView', role: 'symbol', roleHeading: 'Class', abstract: 'A view that presents data using rows in a single column', declaration: 'class UITableView : UIScrollView' },
