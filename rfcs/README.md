...
| [0003 — Swift render service](0003-swift-render-service.md) | P3 | Active, **reordered**: darwin-first side slice. **Phase 1 EXECUTED (2026-06-13)**: `render` module default-on (font-text + symbol-pdf), warm 163×/1497× over JIT spawn, D-0003-3 settled SAFE. Phases 2–3 (prerender batch, spawn kills) next; Linux shaper + hb-view kill deferred (phase 4, revisit-triggered) |
