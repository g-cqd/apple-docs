...
export async function search(opts, ctx) {
  ...
  // Hybrid fusion: blend the lexical order with the semantic order (see
  // src/search/fuse-semantic.js for the invariants). No-op when the
  // semantic tier is dormant.
  if (semanticPromise) {
