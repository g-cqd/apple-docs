...
@Test func declarationLinksKnownTypes() {
    let html: String = render(
        section(
            "declaration",
            json: #"[{"languages":["swift"],"tokens":[{"kind":"keyword","text":"struct"},{"kind":"typeIdentifier","text":"Foo","_resolvedKey":"swiftui/foo"}]}]"#),
...
@Test func parametersList() {
    let html: String = render(
        section("parameters", json: #"[{"name":"value","content":[{"type":"paragraph","inlineContent":[{"type":"text","text":"the value"}]}]}]"#))
    expectEqual(
        html,
...
@Test func discussionSkipsDuplicateHeading() {
    let html: String = render(
        section(
            ...
            json: #"[{"type":"heading","level":2,"text":"Overview"},{"type":"paragraph","inlineContent":[{"type":"text","text":"body"}]}]"#))
...
@Test func restEndpointSpans() {
    let html: String = render(section("rest_endpoint", json: #"[{"kind":"method","text":"GET"},{"kind":"path","text":"/v1/x"}]"#))
    expectEqual(
        html,
